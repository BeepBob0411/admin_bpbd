        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('nama_bencana', old('nama_bencana', $income_category['nama_bencana']), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::date('tanggal_kejadian', old('tanggal_kejadian', $income_category['tanggal_kejadian']), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::time('waktu_kejadian', old('waktu_kejadian', $income_category['waktu_kejadian']), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('lokasi_kejadian', old('lokasi_kejadian', $income_category['lokasi_kejadian']), ['class' => 'form-control', 'placeholder' => '', 'required' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('gambar_berita', old('gambar_berita', $income_category['gambar_berita']), ['class' => 'form-control', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::textarea('deskripsi_berita', old('deskripsi_berita', $income_category['deskripsi_berita']), ['class' => 'form-control ', 'placeholder' => '']) !!}
                    <p class="help-block"></p>
